...
Wompus::Wompus(string type,char symbol, int x_pos,int y_pos):Events(type,symbol,x_pos,y_pos){
   this->type = type;
   this->symbol = symbol;
   this->x_pos = x_pos;
   this->y_pos = y_pos;
...
Wompus::Wompus(const Wompus &old_obj){
...
void Wompus::call_percept(int player_x_pos, int player_y_pos){
...
int Wompus::encounter(int player_x_pos,int player_y_pos){
